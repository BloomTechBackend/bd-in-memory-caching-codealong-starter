...
public class GroupMembershipDao {
    ...
    // TODO 2
    //          The original Dao overloaded the isUserInGroup method. Why?
    //          What changes, if any, will the GroupDao need?
    public boolean isUserInGroup(GroupMembershipCacheKey cacheKey) {
        return this.isUserInGroup(cacheKey.getUserId(), cacheKey.getGroupId());
    }
